...
namespace MovieApp.MVVM.ViewModel
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        [ObservableProperty]
        private TopratedmoviesViewModel _topratedmoviesVM;              //1.Toprated Menü
        ...
        public MainViewModel()
        {
            ...
            CurrentView = HomeVM;
            TopratedmoviesVM = new TopratedmoviesViewModel();          //1. TopratedmoviesViewModel
        ...
        [RelayCommand]                                                  //1.Topratedmovies Menü
        private void NavigateToTopratedmovies()
        {
            if (CurrentView != TopratedmoviesVM)
            {
                CurrentView = TopratedmoviesVM;
            }
        }
